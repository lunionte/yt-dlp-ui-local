import { DownloadProgress } from '../schemas/download.schema.js';

export const PROGRESS_PREFIX = '__PROGRESS__';

export function parseProgressLine(line: string, current: DownloadProgress): { progress?: DownloadProgress; stage?: string } {
